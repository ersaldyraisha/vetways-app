...
angular.module('vetways', ['ionic']).controller('mainController', ['$scope', '$rootScope', function ($scope, $rootScope) {
  $rootScope.pageIndicator = {};
  $rootScope.fragment = '';
  $rootScope.modalTitle = '';
  $rootScope.isModalActive = false;

  $rootScope.changePage = function (next) {
  ...
  $rootScope.toggleModal = function (target, title) {
...
}]).controller('articleController', ['$scope', '$rootScope', function ($scope, $rootScope) {
  $scope.init = function () {
  ...
  $scope.lala = 'lili';
}]).controller('notifController', ['$scope', '$rootScope', function ($scope, $rootScope) {
  $scope.init = function () {
